function [PostprocessData] = Path_Analysis_Kirigami(InputData, PreprocessData)
tol = 6e-3; 
...
elseif strcmpi(InputData.loadType, 'Displacement')
    ...
    RF_dofs = [ 3*(nodes_top-1)+2; 3*(nodes_bottom-1)+2 ];
    Fhis = zeros(numel(RF_dofs), InputData.numberIncrements); 
